...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  Widget _buildTextComposer() {
    return IconTheme(
      data: IconThemeData(color: Theme.of(this.context).colorScheme.secondary),
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Theme.of(this.context).platform == TargetPlatform.iOS
                  ? CupertinoButton(
        ...
        decoration: Theme.of(this.context).platform == TargetPlatform.iOS
            ? BoxDecoration(
